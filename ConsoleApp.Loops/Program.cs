...
{
 Console.WriteLine($"Hello, Wrold! - {i}");
}

Console.WriteLine("********** ISimpleTransactionSuperior For Loop Completed **********");
...
while (num != -1)
{
    Console.Write("Please enter numbers to be summed. (-1 to stop or exit): ");

...
Console.WriteLine("********** SimpleTransactionSuperior IF Results End **********");

// Compled If...Else if...statement - Decide to print letter based on grade value
 ...
 * F : less than 50 X
 */
if(grade < 0 || grade > 100)  // OR(||) at least one side must be true
{
...
else if(grade >= 50 && grade <= 64)  //AND(&&) both side has to be true
{
    Console.WriteLine("C-");
}
...
/*
 * Write a program to accept an integer as the day of the week and print the apprpriate message as outlined below.
 * 1 - Sunday
 * 2 - Monday
 * 3 - Tuesday
